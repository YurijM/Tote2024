...
object Constants {
    ...
    object Errors {
        ...
        const val ERROR_NEW_GAMBLER_IS_NOT_CREATED = "Новый участник не создан"
        ...
        const val ERROR_PROGNOSIS_IS_NOT_FOUND = "Прогноз не найден"
        const val ERROR_STAKE_IS_ABSENT = "Ставка отсутствует"
